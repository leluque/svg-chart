...
public class HorizontalSVG {
    ...
    public static void main(String[] args) throws SVGCouldNotBeLoadedException, EmptyDataSetException, IOException {
        ...
        final SVGPainter painter = new SVGSalamanderPainter(Paths.get("playing-tennis.svg").toUri());
        final SVGChart chart = new SVGChart(painter, dataSet, SVGChart.Directions.HORIZONTAL);
        final BufferedImage image = chart.generateImage(300, 300);
        ImageIO.write(image, "PNG", new File("playing-tennis.png"));
